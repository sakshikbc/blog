...
@section('content')
 <div class="container-fluid por front-bg-main bg-for-pricing small-price">
   ...
   @include('layouts.nav')
        <h1 class="main-front-heading wow fadeInDown text-center display-3">FAQs</h1>
 </div>

  <div class="container-fluid scroll-box" data-speed="1" data-margin="200">
    <div class="row">
               ...
               <div class="panel-group col-md-6">
                  ...
                  <div class="col-md-12">
                        ...
                        Why Customer will buy from My Store &amp; why not from Supplier’s Store?
                          ...
                          <div class="panel-body faq-body">
                            <p>
                            Because you are Providing Customers Wide Range of Products in a Single Store.
                          Supplier can display only some category of products but you can display many products from different categories across the world.
